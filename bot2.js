...
const jbcAddress = process.env.CMJ_JBC_SC;
const bkcAddress = process.env.CMJ_BKC_SC;

// TOKEN ADDRESSES
const tokenJbc = process.env.TOKEN_CMJ_JBC;
const tokenBkc = process.env.TOKEN_CMJ_BKC;
